...
@section('content')
   ...
   <div class="container" dir="rtl">
     <div class="row justify-content-center">
         <div class="col-md-4">
             <div class="card">
                 <div class="card-header bg-primary text-light text-center">القائمة</div>
        ...
        @if (count($errors) > 0)
         ...
         <div class="col-md-8">
            <div class="card">
              ...
              <form action="{{route('meal.edit',$meals->id)}}" method="post" enctype="multipart/form-data">
              	@csrf
              	<input type="hidden"  name="old_image" value="{{ $meals->imge}}">
                <div class="card-body text-right">
                    <div class="form-group">
                        <label for="name">اسم الوجبة</label>
                        <input type="text" class="form-control" value="{{$meals->name}}" name="name" placeholder="اسم الوجبة">
                    </div>
                    <div class="form-group">
                        <label for="description">وصف الوجبة</label>
                        <textarea class="form-control" value="{{$meals->description}}" name="description">{{$meals->description}}</textarea>
                    </div>

                    <div class="row">
                        <div class="col">
                            <label>سعر الوجبة($)</label>
                            <input type="number" value="{{$meals->price}}" name="price" class="form-control" placeholder="سعر الوجبة">
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                       ...
                       <select name="category" value="{{$meals->category}}" class="form-control" required="">{{$meals->category}}
                        ...
                        <br>
                        <div class="form-group">
                            <img id="showImage" src="{{asset($meals->imge)}}" style="width: 100px; height: 100px;"> </div>
